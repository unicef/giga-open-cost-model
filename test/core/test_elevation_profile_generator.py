...
def sample_elevation_profile_results():
    results = [{'results': [{'dataset': 'aster30m',
    'elevation': 289.0,
...
def test_elevation_profile_regression_test(elevation_profile_generator_model,
                                     sample_elevation_data_points,
                                          sample_elevation_profile_results):
    elevations = elevation_profile_generator_model.run(sample_elevation_data_points, samples=4)
