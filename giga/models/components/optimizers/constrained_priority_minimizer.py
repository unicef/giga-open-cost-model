...
class ConstrainedPriorityMinimizer:
    """
    ...
    def _compute_cluster_costs(self, clusters, root_nodes, output):
        ...
        for c in clusters:
            ...
            cluster_schools = [
                n
                for n in list(initial_cost_graph.graph.nodes())
    ...
    def minimize_baseline_costs(
        ...
        economies_of_scale_ids: List[str],
    ):
        """
    ...
    def run_old(self, output: OutputSpace, scenario_id: str) -> List[SchoolConnectionCosts]:
        ...
        (
            ...
            budget_remaining, output, baseline_cost_lookup, baseline_cost_ids, economies_of_scale_ids
        )
