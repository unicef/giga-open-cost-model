...
from giga.compute.elevation.elevation_utilities import format_opendata_request_multipoint_request
...
class ElevationProfileGenerator:
    ...
    def query_elevation_dataset(self, 
        ...
        Input: values: An array of geomteric points (start and endpoints) in the format of 
    ...
    @validate_arguments
    def run(self,  data: List[LatLonPointv1],
            dataset: Text = DEFAULT_DATASET, 
            samples: int = NUMBER_OF_SAMPLES) -> List:
        """
