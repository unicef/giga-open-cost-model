from giga.viz.notebooks.fiber import plot_fiber_map, plot_fiber_connections, default_rwanda_map, interactive_connection_history
from giga.data.space.model_data_space import ModelDataSpace
from giga.schemas.results import CostResultSpace
...
class DataSpaceVisualizer:
    ...
    def plot_fiber_connections(self, results: CostResultSpace, **kwargs):
        ...
        return plot_fiber_connections(fiber_coords, school_coords, distances, m=default_rwanda_map())

    def interactive_fiber_connection_history(self, results, border, **kwargs):
        school_coords = self.data_space.school_coordinates # in blue
        fiber_coords = self.data_space.fiber_coordinates # in green
        distances = results.technology_results.distances
        return interactive_connection_history(border, fiber_coords, school_coords, distances)
