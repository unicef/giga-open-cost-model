def introduction(vals):
    ...
    In {vals['country_name']}, Giga is working with the government to connect schools across the country to the internet. The initiative's goal is to provide reliable and affordable internet access to all schools, teachers, and students in {vals['country_name']} enabling them to access educational resources and participate in the digital economy fully. Giga will support {vals['country_name']} in leveraging existing infrastructure, exploring possible technologies, and supporting the mobilization of financial resources to implement connectivity projects.

    \\subsection*{{Giga School Connectivity Cost Tool}}

    As a foundational step to achieving school connectivity, estimating realistic and credible costs for school connectivity in {vals['country_name']} is essential. To achieve this Giga 
    has utilized its  School Connectivity Costing Tool and applied it to the {vals['country_name']} context. The Costing Tool uses three main layers of data. Firstly, 
    it builds upon the school data gathered though Giga’s Project Connect school mapping initiative. This data includes school geolocations, 
